public class GoalManager
{
    ...
    private void CreateGoal()
    {
        ...
        {
            Console.WriteLine("Invalid: This option does not exist. Please select a number from the menu.");
        }
    }
    ...
    private void LoadGoals()
    {
        ...
        if (files.Length != 0)
        {
            ...
            Console.Write("\nChoose the file to load by its number: ");
    ...
    // additional functions to help the program work
